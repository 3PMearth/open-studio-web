...
function TokenDetail() {
  ...
  const handleIncrease = () =>
    setAmount((prev) => (prev < MAX_CHECKOUT_AMOUNT ? prev + 1 : MAX_CHECKOUT_AMOUNT));
          ...
          <div className="space-y-2">
            ...
            >
              ...
              >
                ...
                />
                {currency === 'krw' && <AiFillCheckCircle color="#30007E" size={24} />}
              </label>
              <label
                className={`${
              ...
              >
                ...
                />
                {currency === 'usd' && <AiFillCheckCircle color="#30007E" size={24} />}
              </label>
            </fieldset>
          </div>
